namespace CuestionarioSistemasInformacion
{
    partial class AnadirPregunta
    {
        ...
        {
			this.btnAnadiNuevaPregunta = new System.Windows.Forms.Button();
			this.btnGuardar = new System.Windows.Forms.Button();
			this.txtPregunta = new System.Windows.Forms.TextBox();
			this.txtRespuestaCorrecta = new System.Windows.Forms.TextBox();
			this.lblAnadirPregunta = new System.Windows.Forms.Label();
			...
			this.Controls.Add(this.lblAnadirPregunta);
			this.Controls.Add(this.txtRespuestaCorrecta);
